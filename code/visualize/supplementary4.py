...
fig.savefig(os.path.join(fig_path, "Supplementary4.svg"), bbox_inches="tight", dpi=300)
fig.savefig(os.path.join(fig_path, "Supplementary4.png"), bbox_inches="tight", dpi=300)
...
fig.tight_layout()
fig.savefig(
    os.path.join(fig_path, "Supplementary4_cbar.svg"), bbox_inches="tight", dpi=300
)
fig.savefig(
    os.path.join(fig_path, "Supplementary4_cbar.png"), bbox_inches="tight", dpi=300
)
